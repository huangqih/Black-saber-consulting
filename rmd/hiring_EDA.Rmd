...
hire_final <- read_csv("~/303 final/Black-saber-consulting/data/phase1-new-grad-applicants-2020.csv")
```
...
# proportion of successful applicants within each sex gruop
hire_phase1 %>% 
...
hire1_mod <- glm(pass ~ gpa + extracurriculars + work_experience, family = binomial(), data = hire_phase1)

hire1_mod_wg <- glm(pass ~ gender + gpa + extracurriculars + work_experience, family = binomial(), data = hire_phase1)

# hire1_mod_fil <- glm(pass ~ gpa + extracurriculars + work_experience, family = binomial(), data = hire_phase1_filtered)
