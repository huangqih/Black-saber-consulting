...
```{r}
# read in the data
curr_employee <- read_csv("~/303 final/Black-saber-consulting/data/black-saber-current-employees.csv")
...
Table 2: Conditional probability table for phase-III candidates
